...
<body>
        ...
        <div class="mx-lg-6 mt-lg-4 mb-lg-4">
        <div class="rounded bg-info pt-4 pb-4">
            <div class="row">
              <div class="col-md-4"></div> <!-- Placeholder column to push PRODUCTS title to center -->
                 <div class="col-md-4 text-center">
                     <h2 class="fw-bold mt-2">PRODUCTS</h2>
             </div>
        <div class="col-md-4 d-flex justify-content-end">
             <a href="{{ route('login', ['user' => 1]) }}" class="btn btn-md btn-primary fw-bold ms-3 h-75">Login</a>
             <a href="{{ route('register', ['user' => 2]) }}" class="btn btn-md btn-success fw-bold ms-3 h-75">Register</a>
        </div>
</div>
